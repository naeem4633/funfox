...
const Page1 = () => {
  return (
    <section className="w-screen h-screen short-stack-regular">
      <div className='flex justify-center items-center w-full h-full'>
        <div className="relative w-[1280px] h-full border border-black">
            <div className="absolute inset-0 flex flex-col items-center border border-black">
              ...
              <div className='w-10/12 flex flex-col items-center h-fit border border-black space-y-2'>
                <div className='relative w-1/2 border border-black'>
                  <div className="absolute inset-0 flex justify-center items-center border border-black">
                    <p className='text-3xl text-white'>Elements Of Story Writing</p>
                  </div>
                  <img className='w-full py-2' src='./images/topic-container.png'></img>
                </div>
                <div className='w-full border border-black text-2xl'>
                ...
                <div className='relative w-full border border-black text-2xl'>
                  <div className="absolute inset-0 flex justify-center items-center border border-black px-6 ">
                    <div className='w-5/6'>
                    ...
                    <div className='flex justify-end w-1/6'>
                      <img className='w-28' src='./images/boy.png'></img>
                    </div>
                  </div>
                  <img className='w-full' src='./images/container-primary.png'></img>
                </div>
                ...
                <div className='grid grid-cols-5 text-black text-xl'>
                  <div className='relative w-full border border-black p-2'>
                    ...
                    <img className='w-full py-2' src='./images/cloud-1.png'></img>
                  </div>
                  <div className='relative w-full border border-black p-2'>
                    <div className="absolute inset-0 flex justify-center items-center border border-black">
                      <p className=''>CHARACTERS</p>
                    </div>
                    <img className='w-full py-2' src='./images/cloud-2.png'></img>
                  </div>
                  <div className='relative w-full border border-black p-2'>
                    <div className="absolute inset-0 flex justify-center items-center border border-black">
                      <p className=''>PLOT</p>
                  ...
                  <div className='relative w-full border border-black p-2'>
                    ...
                    <img className='w-full py-2' src='./images/cloud-3.png'></img>
                  </div>
                  <div className='relative w-full border border-black p-2'>
                    <div className="absolute inset-0 flex justify-center items-center border border-black">
                      <p className=''>RESOLUTION</p>
                    </div>
                    <img className='w-full py-2' src='./images/cloud-4.png'></img>
                  </div>
                </div>
                ...
                <div className='relative w-full border border-black text-2xl py-7'>
                  <div className="absolute inset-0 flex justify-center items-center border border-black px-6">
                    <div className='w-full flex flex-col border border-black px-6 pb-5'>
                  ...
                  <img className='w-full' src='./images/container-secondary.png'></img>
                </div>
              </div>

              <div className='w-11/12 flex justify-between border border-black px-4 py-2'>
                <img className='w-14' src='./images/voice-icon.png'></img>
                <div className='flex justify-center items-center space-x-2'>
                  <Link to={''}><img className='w-10' src='./images/button-previous.png'></img></Link>
                  <img className='w-20' src='./images/page-number-1.png'></img>
                  <Link to={'page-2'}><img className='w-10' src='./images/button-next.png'></img></Link>
                </div>
                <img className='w-14' src='./images/voice-icon.png'></img>
              </div>
            </div>
